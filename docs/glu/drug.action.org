...
** 接口细节
   ...
   + 返回数据 :: 返回对应的最优的调整建议，在短效和速效药情况下是多条，其余情况就是一条
             ...
             "info" : "Success", 
             "data" : [
             {"name":"药物名称A", "time":0, "type": 0, "value": 1.0, "adjust_type": 1 /*药物增加&减少&停止类型*/, "adjust_value": 2},
             {"name":"药物名称B", "time":0, "type": 0, "value": 1.0, "adjust_type": 2 /*药物增加&减少&停止类型*/, "adjust_value": 0},
             ]
             }
             #+END_SRC
